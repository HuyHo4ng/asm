...
namespace asm.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LecturerID,LecturerName,Department")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LecturerID,LecturerName,Department")] Lecturer lecturer)
        {
